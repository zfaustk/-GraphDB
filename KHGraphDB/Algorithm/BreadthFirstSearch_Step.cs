...
{
    class BreadthFirstSearch_Step : Algorithm , IAlgorithm
    {
        #region Construct
        ...
        public void BeginAlgorithm(IGraph theGraph)
        {
            ...
            Parallel.ForEach<IVertex>(theGraph.Vertices, v =>
            {
                ...
                v.AlgorithmObjs[DISTANCE_ATTRIBUTE_KEY] = 0;
            });

            double d;
            Parallel.ForEach<IEdge>(theGraph.Edges, e =>
            {
                try { d = Convert.ToDouble(e[DistanceKey]); }
                catch { d = 1; }
                e.AlgorithmObjs[DISTANCE_ATTRIBUTE_KEY] = d;
            });
        }
        ...
        //public List<IVertex> Search(IGraph theGraph, IVertex theSource, String KeyName, Int32 MaxDistance, Func<IVertex, bool> theMatchingFunc = null)
        //{
        //    return Search(theGraph, theSource, KeyName, MaxDistance, true, theMatchingFunc);
        //}
        ...
        ///// <returns></returns>
        //public List<IVertex> Search(IGraph theGraph, IVertex theSource, String KeyName, Int32 MaxDistance, bool Reverted, Func<IVertex, bool> theMatchingFunc = null)
        //{
        //    #region Init
        //    DistanceKey = KeyName;
